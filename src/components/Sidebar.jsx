...
export default function Sidebar({ isOpen, setIsOpen }) {
    return (
        <>
            ...
            {/* Sidebar */}
            <aside className={`fixed top-0 left-0 h-screen w-64 border-r border-slate-200 dark:border-primary/20 bg-background-light/50 dark:bg-background-dark/50 backdrop-blur-xl z-50 flex flex-col transition-transform duration-300 lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="p-6 lg:p-8 flex flex-col items-center text-center">
                    <div className="w-20 h-20 lg:w-24 lg:h-24 rounded-full overflow-hidden border-4 border-primary/50 shadow-md mb-4 relative">
                        <img src={profilePic} alt="Muhammad Abdullah" className="w-full h-full object-cover object-[center_60%]" />
                    </div>
                    <h2 className="text-slate-900 dark:text-slate-100 text-lg lg:text-xl font-bold tracking-tight leading-none mb-2">
                        Muhammad<br />Junaid
                    </h2>
                ...
                <div className="p-4 lg:p-6 border-t border-slate-200 dark:border-primary/10">
            ...
            <button 
                className="fixed top-4 left-4 z-30 lg:hidden bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-sm p-3 rounded-xl border border-slate-200 dark:border-white/10 shadow-lg"
